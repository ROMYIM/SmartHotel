...
function b64_md5(s: any) { return rstr2b64(rstr_md5(str2rstr_utf8(s))); }
function any_md5(s: any, e: any) { return rstr2any(rstr_md5(str2rstr_utf8(s)), e); }
function hex_hmac_md5(k: any, d: any) { return rstr2hex(rstr_hmac_md5(str2rstr_utf8(k), str2rstr_utf8(d))); }
function b64_hmac_md5(k: any, d: any) { return rstr2b64(rstr_hmac_md5(str2rstr_utf8(k), str2rstr_utf8(d))); }
function any_hmac_md5(k: any, d: any, e: any) { return rstr2any(rstr_hmac_md5(str2rstr_utf8(k), str2rstr_utf8(d)), e); }
 ...
 */
function rstr2any(input: string, encoding: { length: number; charAt: (arg0: any) => string; }) {
 ...
 */
function str2rstr_utf16le(input: { length: number; charCodeAt: { (arg0: number): number; (arg0: number): number; }; }) {
  var output = "";
  for (var i = 0; i < input.length; i++)
...
function str2rstr_utf16be(input: { length: number; charCodeAt: { (arg0: number): number; (arg0: number): number; }; }) {
  var output = "";
  for (var i = 0; i < input.length; i++)
 ...
 */
function rstr2binl(input: { length: number; charCodeAt: (arg0: number) => number; }) {
